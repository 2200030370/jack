...
<body>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>Hari kailash</h2>
                            <p>Hari kailash also takes on the role of a full-stack developer to help expedite the project's completion. 
                       ...
                       <div class="social">
                          <a href="https://wa.me/+919063133461" target="_blank"><i class="fab fa-whatsapp"></i></a>
                          <a href="https://www.linkedin.com/in/anchala-hari-kailash/" target="_blank"><i class="fab fa-linkedin"></i></a>
                         <a href="https://www.instagram.com/__mr__official__123/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a>  
                          <a href="https://github.com/220030370" target="_blank"><i class="fab fa-github"></i></a>      
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>Sai Karthik</h2>
                            <p>Sai Karthik is the front-end developer and user interface (UI) designer. 
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="main-text">
                            <h2>Roshan</h2>
                            <p>Roshan is the back-end developer and database specialist. 
                ...
                <div class="col-lg-5 mb-5 mb-lg-0">
                    <div class="bg-light d-flex flex-column justify-content-center px-5" style="height: 450px;">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="mt-n1">
                                <h4>Email Us</h4>
                                <a href="https://mail.google.com//mail/?view=cm&fs=1&tf=1&to=harikailsh2004@gmail.com" target="_blank"><p class="m-0">klsdpprojects@gmail.com</p></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="footer-content">
        ...
        <ul class="wrapper">
            ...
            <span><a href="https://wa.me/+919063133461" target="_blank"><i class="fab fa-whatsapp"></i></a></span>    
            </li>
